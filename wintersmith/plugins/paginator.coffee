module.exports = (env, callback) ->
  ...
  getArticles = (contents) ->
    ...
    articlesAll = env.ContentTree.flatten contents[options.articles]
    articles = articlesAll.filter (content) -> content.constructor.name != "StaticFile"
  ...
  class PaginatorPage extends env.plugins.Page
    ...
    getView: -> (env, locals, contents, templates, callback) ->
      ...
      ctx = {env, contents, @articles, @prevPage, @nextPage, page : this}
