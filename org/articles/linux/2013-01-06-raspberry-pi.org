...
4. 完成设置后，整个网络数据流如下:\\
   Pi ==> internet
   #+BEGIN_SRC ditaa :file ../img/raspberry-pi--pi2internet.png :cmdline -r :eval no-export
             +----------------+   +-------------------------+    
   ...
   Ineternet ==> Pi
   #+BEGIN_SRC ditaa :file ../img/raspberry-pi--internet2pi.png :cmdline -r :eval no-export
   +-------------------------------+   +------------+   +--------------------------------------+
...
[[file:../img/Raspberry-Pi-iphone-remote-desktop.jpg]]
